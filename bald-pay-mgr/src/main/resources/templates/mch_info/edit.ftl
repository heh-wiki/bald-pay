<div style="margin: 15px;">
    <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="mchId" placeholder="请输入商户ID" autocomplete="off" class="layui-input"
                           readonly="readonly" value="${item.mchId?if_exists }">
                </div>
            </div>
        </#if>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" lay-verify="required" placeholder="请输入商户名称" autocomplete="off"
        ...
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">Request-Key</label>
            <div class="layui-input-block">
                <textarea name="reqKey" placeholder="请输入请求签名密钥" lay-verify="required"
                          class="layui-textarea">${item.reqKey?if_exists }</textarea>
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">Response-Key</label>
            <div class="layui-input-block">
                <textarea name="resKey" placeholder="请输入返回签名密钥" lay-verify="required"
