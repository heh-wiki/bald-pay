//package wiki.heh.bald.pay.message.mq;
//
...
//import wiki.heh.bald.pay.message.service.BaseService;
//
//import java.net.URI;
...
//
//    protected static final Logger _log = LoggerFactory.getLogger(Mq4PayNotify.class);
//
