...
public class Result<T> {
     ...
     * @param errorType
     */
    public Result(PayServiceErrorType errorType) {
     ...
     * @param data
     */
    public Result(PayServiceErrorType errorType, T data) {
        this(errorType);
        this.data = data;
    }
    ...
    public static Result fail() {
        return new Result(PayServiceErrorType.SYSTEM_ERROR);
    }

    public static Result fail(PayServiceErrorType errorType) {
